...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [𝚂𝙾𝙽𝚈𝙴𝙹𝙸𝙽𝙽] --*' + 
                                    '\n*𝚂𝙾𝙽𝚈𝙴𝙹𝙸𝙽𝙽 an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [𝚂𝙾𝙽𝚈𝙴𝙹𝙸𝙽𝙽] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
